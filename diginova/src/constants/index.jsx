...
export const features = [
  {
    ...
    description:
      "Streamline your workflows with intelligent automation, reducing manual effort and boosting efficiency.",
  },
  {
    icon: <Fingerprint />,
    text: "Seamless Integration",
    description:
      "Easily connect with your favorite tools and platforms, ensuring smooth and hassle-free digital operations.",
  },
  {
    icon: <ShieldHalf />,
  ...
  },
  {
    ...
    description:
      "Make data-driven decisions with live analytics and reports, giving you a deeper understanding of your business performance.",
  },
  {
    icon: <PlugZap />,
